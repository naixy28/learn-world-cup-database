...
echo "$($PSQL "SELECT name FROM games LEFT JOIN teams ON teams.team_id=games.winner_id OR teams.team_id=games.opponent_id WHERE round ILIKE '%eight%' AND year=2014 ORDER BY name")"
